About pytest-sftpserver-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-sftpserver-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3293&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-sftpserver-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-sftpserver` can be installed with `conda`:
...
```
mamba install pytest-sftpserver
```

It is possible to list all of the versions of `pytest-sftpserver` available on your platform with `conda`:
...
```
mamba search pytest-sftpserver --channel conda-forge
```
...
mamba repoquery search pytest-sftpserver --channel conda-forge

# List packages depending on `pytest-sftpserver`:
mamba repoquery whoneeds pytest-sftpserver --channel conda-forge

# List dependencies of `pytest-sftpserver`:
mamba repoquery depends pytest-sftpserver --channel conda-forge
```
